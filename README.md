...
2. **Sign Up**  
   <img src="img/signup.jpg" width="400">

3. **Welcome Screen**  
   <img src="img/welcomeScreen.jpg" width="400">

4. **Health Input**  
   <img src="img/heatlhInput.jpg" width="400">
   
5. **Home Screen**  
   <img src="img/homescreen.jpg" width="400">

6. **Predictions**  
   <img src="img/predictions.jpg" width="400">

7. **Visualizations**  
    <img src="img/visualizations2.jpg" width="400">

8. **Recommendations**  
    <img src="img/reccomendations.jpg" width="400">

9. **Assessment Profile**  
   <img src="img/assesmentProfile.jpg" width="400">

10. **Menu**  
   <img src="img/menu.jpg" width="400">

11. **Edit Profile**  
   <img src="img/editProfile.jpg" width="400">

12. **User Profile**  
    <img src="img/userProfile.jpg" width="400">
