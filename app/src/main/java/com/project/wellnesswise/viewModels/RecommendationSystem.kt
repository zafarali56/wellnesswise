class HealthRecommendationSystem {
    ...
    private fun generateDiabetesRecommendations(risk: Float): String {
        return when {
            ...
            risk < 0.4f -> "Your diabetes risk is mild. While you're on the right track, consider fine-tuning your diet by reducing refined sugars and increasing fiber intake. Your current habits are already helping you maintain good health."
    ...
    private fun generateCardiovascularRecommendations(risk: Float): String {
        return when {
            ...
            risk < 0.4f -> "Your cardiovascular risk is mild. Your heart-healthy habits are showing positive results. Consider regular check-ups and maintain your current lifestyle while looking for ways to further improve."
    ...
    private fun generateHypertensionRecommendations(risk: Float): String {
        return when {
            ...
            risk < 0.4f -> "Your blood pressure risk is mild. Your current habits are working well. Consider optimizing your diet further by increasing potassium-rich foods while maintaining your low-sodium approach."
    ...
    private fun generateObesityRecommendations(risk: Float): String {
        return when {
            ...
            risk < 0.4f -> "Your weight-related risk is mild. Your current lifestyle choices are showing positive results. Continue focusing on portion control and regular physical activity while looking for ways to optimize further."
    ...
    private fun generateCancerRecommendations(risk: Float): String {
        return when {
            ...
            risk < 0.4f -> "Your cancer risk is mild. Your current lifestyle choices are showing positive results. Stay up-to-date with recommended screenings while maintaining your healthy habits."
